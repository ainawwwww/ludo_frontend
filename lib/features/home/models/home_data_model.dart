  ...
  factory HomeDataModel.fromJson(Map<String, dynamic> json) {
    ...
    return HomeDataModel(
      ...
      currentLeague: data['current_league'] is Map<String, dynamic>
          ? LeagueSummary.fromJson(
              data['current_league'] as Map<String, dynamic>)
          : null,
      isLeagueLocked: data['is_league_locked'] == true || lvl < 4,
      leagueUnlockLevel:
          data['league_unlock_level'] is int ? data['league_unlock_level'] : 4,
      globalRank: data['global_rank'] is int
          ? data['global_rank']
          : int.tryParse(data['global_rank'].toString()) ?? 0,
