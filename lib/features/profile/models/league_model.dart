  ...
  factory LeagueSeasonInfo.fromJson(Map<String, dynamic> json) {
    return LeagueSeasonInfo(
      ...
      seasonNumber: json['season_number'] is int
          ? json['season_number']
          : int.tryParse(json['season_number'].toString()) ?? 1,
  ...
  factory LeagueUserSummary.fromJson(Map<String, dynamic> json) {
    return LeagueUserSummary(
      ...
      tierOrder: json['tier_order'] is int
          ...
          : int.tryParse(json['tier_order'].toString()) ?? 1,
      iconUrl: json['icon_url']?.toString(),
      lifetimePoints: json['lifetime_points'] is int
          ? json['lifetime_points']
          : int.tryParse(json['lifetime_points'].toString()) ?? 0,
      divisionNumber: json['division_number'] is int
          ? json['division_number']
          : int.tryParse(json['division_number'].toString()) ?? 1,
      myRankInDivision: json['my_rank_in_division'] is int
          ? json['my_rank_in_division']
          : int.tryParse(json['my_rank_in_division'].toString()) ?? 1,
      pointsNeededForNextTier: json['points_needed_for_next_tier'] is int
          ? json['points_needed_for_next_tier']
          : int.tryParse(json['points_needed_for_next_tier'].toString()) ?? 0,
      isLocked: json['is_locked'] == true,
      unlockLevel: json['unlock_level'] is int
          ? json['unlock_level']
          : int.tryParse(json['unlock_level']?.toString() ?? '') ?? 4,
    );
  }
}
...
class LeagueDivisionMemberModel {
  ...
  factory LeagueDivisionMemberModel.fromJson(Map<String, dynamic> json) {
    return LeagueDivisionMemberModel(
      ...
      pointsInDivision: json['points_in_division'] is int
          ? json['points_in_division']
          : int.tryParse(json['points_in_division'].toString()) ?? 0,
...
class LeagueDivisionResponse {
  ...
  factory LeagueDivisionResponse.fromJson(Map<String, dynamic> json) {
    ...
    final membersList = (data['division_members'] as List<dynamic>?)
            ?.map((e) =>
                LeagueDivisionMemberModel.fromJson(e as Map<String, dynamic>))
            .toList() ??
        [];

    return LeagueDivisionResponse(
      season: LeagueSeasonInfo.fromJson(data['season'] as Map<String, dynamic>),
      userSummary: LeagueUserSummary.fromJson(
          data['user_summary'] as Map<String, dynamic>),
