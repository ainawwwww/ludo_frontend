...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  final List<_OnboardingItem> _items = const [
    _OnboardingItem(
      ...
      subtitle: 'Compete in high-stakes Ludo matches and claim gold coins, gems & exclusive rewards every single day!',
      iconData: Icons.emoji_events_rounded,
      accentColor: Color(0xFFFFD700),
    ),
    _OnboardingItem(
      title: 'MULTIPLAYER BETTING BATTLES',
      subtitle: 'Experience classic Ludo, Domino & Jackaroo with smooth real-time betting lobbies.',
      iconData: Icons.casino_rounded,
      accentColor: Color(0xFFF97023),
    ),
    _OnboardingItem(
      title: 'LIVE VOICE ROOMS & CHAT',
      subtitle: 'Talk with teammates, join battle rooms, send gift drops, and build your gaming community.',
