...
class BottomNavBar extends ConsumerWidget {
  ...
  static const _items = [
    (BottomNavItem.events, 'assets/graphics/nav_events.png', 'Events', AppConstants.eventsRoute),
    (BottomNavItem.battle, 'assets/graphics/nav_battle.png', 'Battle', AppConstants.homeRoute),
    (BottomNavItem.chat, 'assets/graphics/nav_chat.png', 'Chat', AppConstants.battleLobbyRoute),
    (BottomNavItem.social, 'assets/graphics/nav_social.png', 'Social', AppConstants.friendsRoute),
  ];
                        ...
                        if (isSelected)
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color(0xFFD500F9).withOpacity(0.85), // Bright glowing pink/purple
                                  blurRadius: 24 * scale,
                                  spreadRadius: 2 * scale,
                                ),
                                BoxShadow(
                                  color: Colors.blueAccent.withOpacity(0.5), // Secondary blue glow layer
                                  blurRadius: 16 * scale,
                                  spreadRadius: 0,
                                ),
                              ],
